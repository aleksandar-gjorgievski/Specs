...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca340finn/nca-340-4-ios.git', :branch => 'NCA340-4625-adapt-launch-screen-with-overlay-fix-TEST-WITH-LOCAL-CORE', :submodules => true  }
