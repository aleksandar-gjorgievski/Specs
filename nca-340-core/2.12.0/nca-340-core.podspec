...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://extranet.netcetera.biz/bitbucket/scm/nca340finn/nca-340-4-ios.git', :branch => 'master-2.12', :submodules => true  }
  ...
  s.resources = 'lib/**', 'src/common/**/*.xib', 'src/**/*.storyboard', 'src/common/**/*.png', 'src/common/resources/Images.xcassets', 'src/common/**/*.html', 'src/common/**/*.strings', 'src/common/**/*.xml', 'src/common/**/*.mustache', 'src/common/**/termsOfUse.txt', 'src/common/**/touchIDTermsOfUse.txt', 'src/common/**/faceIDTermsOfUse.txt', '/src/common/**/*.trm', 'src/common/**/texts.trm'
